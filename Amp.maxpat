...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 58.0, 172.5, 100.0, 40.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 191.0, 47.0, 40.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 190.893815279006958, 859.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 123.893815279006958, 859.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 200.0, 563.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 136.0, 563.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1241.0, 91.0, 62.0, 22.0 ],
					"text" : "live.banks"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1006.0, 20.0, 48.0, 30.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 119.0, 100.0, 48.0, 30.0 ],
...
, 			{
				"box" : 				{
					"activeslidercolor" : [ 0.227450980392157, 0.980392156862745, 0.996078431372549, 1.0 ],
					"appearance" : 2,
					"id" : "obj-61",
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 224.666673362255096, 736.666688621044159, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 165.0, 100.0, 42.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"activeslidercolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 281.0, 759.0, 30.0, 50.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 344.0, 74.0, 40.0, 22.0 ],
					"text" : "* 1.27"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 247.0, 85.0, 40.0, 22.0 ],
					"text" : "* 1.27"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 344.0, 291.0, 45.0, 22.0 ],
					"text" : "$1 400"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 247.0, 291.0, 45.0, 22.0 ],
					"text" : "$1 400"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 247.0, 376.0, 75.0, 22.0 ],
					"text" : "onepole~ 10"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 247.0, 331.0, 58.0, 22.0 ],
					"text" : "line~ 200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 344.0, 376.0, 75.0, 22.0 ],
					"text" : "onepole~ 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 344.0, 331.0, 58.0, 22.0 ],
					"text" : "line~ 200"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 770.75, 252.0, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 483.0, 494.0, 50.0, 22.0 ],
					"text" : "-1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 663.5, 452.0, 161.0, 22.0 ],
					"text" : "expr ($f1 + ($f2 * 2 - 1) * 25)"
				}

			}
, 			{
				"box" : 				{
					"bgcolor" : [ 0.54902, 0.839216, 0.0, 1.0 ],
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"outlinecolor" : [ 0.439216, 0.576471, 0.007843, 1.0 ],
					"parameter_enable" : 0,
					"patching_rect" : [ 474.0, 257.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 434.0, 582.0, 96.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 434.0, 543.0, 171.0, 22.0 ],
					"text" : "counter 1 360"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 921.0, 864.0, 133.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1071.0, 247.0, 55.0, 22.0 ],
					"text" : "xfade $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1071.0, 220.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1073.0, 410.0, 48.0, 20.0 ],
					"text" : "jit.xfade"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1473.0, 174.0, 65.0, 20.0 ],
					"text" : "loadmess 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1513.0, 225.0, 88.0, 22.0 ],
					"text" : "prepend shape"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1473.0, 203.0, 100.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1312.0, 273.0, 265.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 612.0, 592.0, 92.0, 20.0 ],
					"text" : "zmap 0. 1. 20. 50."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 606.5, 699.0, 182.0, 20.0 ],
					"text" : "fog_params 0.09 0. 0.5 1. 4.78 1. $1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 672.0, 650.0, 37.0, 20.0 ],
					"text" : "- 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 672.0, 628.0, 32.5, 20.0 ],
					"text" : "/ 10."
				}
...
,
					"patching_rect" : [ 247.0, 111.5, 63.0, 20.0 ],
...
,
					"patching_rect" : [ 344.0, 97.5, 63.0, 20.0 ],
					"saved_object_attributes" : 					{
						"editing_bgcolor" : [ 0.56078431372549, 0.56078431372549, 0.56078431372549, 1.0 ],
						"globalpatchername" : "",
						"locked_bgcolor" : [ 0.56078431372549, 0.56078431372549, 0.56078431372549, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 770.75, 229.0, 136.0, 20.0 ],
					"text" : "rotate 50.67 -0.85 -0.5 -0.12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1633.0, 509.0, 79.0, 20.0 ],
					"text" : "loadmess 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 817.75, 544.5, 89.0, 20.0 ],
					"text" : "zmap 0. 1. -2. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 817.75, 567.0, 108.0, 20.0 ],
					"text" : "position 0.06 0.08 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 929.0, 229.0, 32.5, 20.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1220.0, 285.0, 65.0, 20.0 ],
					"text" : "loadmess 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1073.0, 285.0, 71.0, 20.0 ],
					"text" : "loadmess 13"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 770.75, 172.5, 79.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 757.0, 8.5, 194.0, 148.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 223.125, 35.375, 127.0, 120.25 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1582.0, 296.0, 32.5, 22.0 ],
					"text" : "30"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1205.0, 430.0, 149.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1192.0, 509.0, 146.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1406.0, 522.0, 126.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1604.0, 475.0, 79.0, 20.0 ],
					"text" : "displacement"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1589.0, 450.0, 63.0, 20.0 ],
					"text" : "time offset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1575.0, 425.0, 68.0, 20.0 ],
					"text" : "basis scale"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1561.0, 509.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1541.0, 450.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1527.0, 425.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1485.0, 399.0, 83.0, 22.0 ],
					"text" : "prepend basis"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1472.0, 371.0, 45.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1515.0, 369.0, 51.0, 33.0 ],
					"text" : "basis function"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1497.0, 472.0, 34.0, 22.0 ],
					"text" : "r rez"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1031.0, 494.0, 127.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1336.0, 521.0, 71.0, 22.0 ],
					"text" : "jit.op @op *"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1156.0, 493.0, 71.0, 22.0 ],
					"text" : "jit.op @op *"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1336.0, 496.0, 225.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1336.0, 470.0, 158.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1413.0, 345.0, 115.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1400.0, 314.0, 45.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1445.0, 314.0, 81.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1325.0, 384.0, 34.0, 22.0 ],
					"text" : "r rez"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1260.0, 336.0, 88.0, 22.0 ],
					"text" : "prepend shape"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1219.5, 313.0, 100.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1317.0, 314.0, 74.0, 20.0 ],
					"text" : "mesh shape"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1120.0, 314.0, 94.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1111.0, 438.0, 34.0, 22.0 ],
					"text" : "r rez"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1096.0, 464.0, 233.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1028.0, 802.0, 152.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1028.0, 766.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1016.0, 819.0, 180.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 972.0, 783.0, 272.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1028.0, 679.0, 85.0, 20.0 ],
					"text" : "color: R G B A"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1113.0, 699.0, 41.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1071.0, 699.0, 41.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1029.0, 699.0, 41.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 947.0, 733.0, 167.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 984.0, 699.0, 41.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1111.0, 354.0, 36.0, 22.0 ],
					"text" : "s rez"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 976.0, 438.0, 34.0, 22.0 ],
					"text" : "r rez"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 961.0, 525.0, 80.0, 60.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 961.0, 494.0, 73.0, 22.0 ],
					"text" : "jit.op @op +"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 961.0, 464.0, 136.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 922.5, 668.0, 78.0, 22.0 ],
					"text" : "camera 0 0 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1600.0, 563.0, 18.0, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1289.0, 783.0, 110.0, 22.0 ],
					"text" : "s ---mesh_settings"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1582.0, 543.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1289.0, 699.0, 20.0, 20.0 ],
					"svg" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1289.0, 723.0, 105.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1172.0, 699.0, 20.0, 20.0 ],
					"svg" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1172.0, 723.0, 114.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 901.0, 895.0, 251.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1115.0, 617.0, 119.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1129.0, 593.0, 83.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1454.0, 591.0, 83.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1437.0, 615.0, 119.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1343.0, 616.0, 87.0, 22.0 ],
					"text" : "auto_colors $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1343.0, 593.0, 20.0, 20.0 ],
					"svg" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1239.0, 616.0, 97.0, 22.0 ],
					"text" : "auto_normals $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1239.0, 593.0, 20.0, 20.0 ],
					"svg" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1028.0, 650.0, 217.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1045.0, 553.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1152.0, 567.0, 256.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1152.0, 547.0, 36.0, 22.0 ],
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1336.0, 445.0, 71.0, 22.0 ],
					"text" : "jit.op @op *"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1227.0, 410.0, 248.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1059.0, 384.0, 265.0, 22.0 ],
					"text" : "jit.gl.gridshape @matrixoutput 1 @shape sphere"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1073.0, 336.0, 61.0, 22.0 ],
					"text" : "dim $1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1073.0, 314.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 966.0, 279.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 975.0, 394.0, 59.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 929.0, 371.0, 65.0, 22.0 ],
					"text" : "t b erase b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 929.0, 331.0, 47.0, 22.0 ],
					"text" : "jit.qball"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 929.0, 306.0, 56.0, 22.0 ],
					"text" : "metro 55"
				}
...
, 			{
				"box" : 				{
					"activedialcolor" : [ 0.227451, 0.980392, 0.996078, 1.0 ],
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 651.0, 20.0, 44.0, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 66.0, 120.5, 44.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"activedialcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					"activedialcolor" : [ 0.227451, 0.980392, 0.996078, 1.0 ],
					"activeneedlecolor" : [ 1.0, 1.0, 1.0, 0.6 ],
					"annotation" : "Set the early reflections",
					"annotation_name" : "Early",
					"focusbordercolor" : [ 1.0, 1.0, 1.0, 0.6 ],
					"id" : "obj-49",
					"maxclass" : "live.dial",
					"numinlets" : 1,
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 588.0, 20.0, 44.0, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 20.0, 28.5, 44.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"activedialcolor" : 						{
							"expression" : ""
						}
...
,
						"valueof" : 						{
							"parameter_annotation_name" : "Early",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 507.0, 20.0, 44.0, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 163.0, 28.5, 44.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"activedialcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					"activedialcolor" : [ 0.227451, 0.980392, 0.996078, 1.0 ],
					"activeneedlecolor" : [ 1.0, 1.0, 1.0, 0.6 ],
					"annotation" : "Adjust hte Stereo width",
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 422.0, 20.0, 44.0, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 114.0, 120.5, 44.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"activedialcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 192.5, 131.5, 37.0, 20.0 ],
					"text" : "* 100."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 167.5, 20.0, 44.0, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 20.0, 120.5, 44.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"activedialcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 247.0, 139.0, 92.0, 20.0 ],
					"text" : "zmap 0 102 0.1 50"
				}
...
, 			{
				"box" : 				{
					"activedialcolor" : [ 0.227451, 0.980392, 0.996078, 1.0 ],
					"activeneedlecolor" : [ 1.0, 1.0, 1.0, 0.6 ],
					"annotation" : "Adjust the Reverb Time",
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 247.0, 20.0, 44.0, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 66.0, 28.5, 44.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"activedialcolor" : 						{
							"expression" : ""
						}
...
,
						"valueof" : 						{
							"parameter_annotation_name" : "Time",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 344.0, 138.5, 100.0, 20.0 ],
					"text" : "zmap 0 102 0.1 300"
				}
...
, 			{
				"box" : 				{
					"activedialcolor" : [ 0.227451, 0.980392, 0.996078, 1.0 ],
					"activeneedlecolor" : [ 1.0, 1.0, 1.0, 0.6 ],
					"annotation" : "The size of the virtual room",
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 344.0, 20.0, 44.0, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 114.0, 28.5, 44.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"activedialcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 54.0, 479.0, 37.0, 20.0 ],
					"text" : "* 100."
				}
...
, 			{
				"box" : 				{
					"activedialcolor" : [ 0.227451, 0.980392, 0.996078, 1.0 ],
					"activeneedlecolor" : [ 1.0, 1.0, 1.0, 0.6 ],
					"annotation" : "The mix balance between the dry and the wet signal. Set it to 100% wet if the device is placed on a return track.",
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 76.0, 393.0, 44.0, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 163.0, 120.5, 44.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"activedialcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 123.893815279006958, 793.80537360906601, 86.0, 20.0 ],
					"text" : "pluggo.dryWet~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 192.5, 161.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.5, 191.5, 65.0, 22.0 ],
					"text" : "spread $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 676.0, 142.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 676.0, 172.5, 43.0, 22.0 ],
					"text" : "tail $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 613.0, 142.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 613.0, 172.5, 54.0, 22.0 ],
					"text" : "early $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 344.0, 161.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 532.0, 142.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 532.0, 172.5, 75.0, 22.0 ],
					"text" : "damping $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 447.0, 142.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 447.0, 172.5, 84.0, 22.0 ],
					"text" : "bandwidth $1"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1097.0, 195.0, 30.0, 22.0 ],
									"text" : "in 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 571.0, 87.0, 30.0, 22.0 ],
									"text" : "in 3"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 900.0, 330.000014999999962, 75.0, 20.0 ],
									"text" : "prediffuse"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 840.0, 390.0, 45.0, 22.0 ],
									"text" : "+"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 840.0, 330.000014999999962, 32.5, 22.0 ],
									"text" : "-"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 913.0, 212.000014999999991, 43.0, 22.0 ],
									"text" : "* 0.75"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 937.0, 151.0, 70.0, 22.0 ],
									"text" : "* 0.110732"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1097.0, 367.0, 240.0, 35.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 1014.5, 104.999992000000006, 90.0, 20.0 ],
									"text" : "input damper"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1185.0, 249.0, 163.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 675.0, 53.5, 135.0, 35.0 ],
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 1106.5, 429.869415000000004, 954.5, 429.869415000000004 ],
									"order" : 3,
									"source" : [ "obj-35", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 1106.5, 429.869415000000004, 1104.5, 429.869415000000004 ],
									"order" : 2,
									"source" : [ "obj-35", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 1106.5, 431.333496000000025, 1254.5, 431.333496000000025 ],
									"order" : 1,
									"source" : [ "obj-35", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 1106.5, 428.405304000000001, 1404.5, 428.405304000000001 ],
									"order" : 0,
									"source" : [ "obj-35", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 1106.5, 429.0, 313.5, 429.0 ],
									"order" : 6,
									"source" : [ "obj-35", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 1106.5, 429.0, 613.5, 429.0 ],
									"order" : 4,
									"source" : [ "obj-35", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 1106.5, 429.0, 463.5, 429.0 ],
									"order" : 5,
									"source" : [ "obj-35", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 1106.5, 429.0, 163.5, 429.0 ],
									"order" : 7,
									"source" : [ "obj-35", 0 ]
								}
...
,
					"patching_rect" : [ 239.0, 685.0, 150.0, 22.0 ],
					"text" : "gen~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 181.0, 591.0, 17.0, 18.0 ],
					"text" : "L",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 75.0, 376.0, 117.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 113.0, 628.0, 53.0, 20.0 ],
					"text" : "plugin~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1001.0, 20.0, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 13.5, 359.0, 171.0 ],
					"proportion" : 0.39,
					"rounded" : 27
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-35", 0 ],
					"midpoints" : [ 685.5, 435.75, 248.5, 435.75 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-95", 0 ],
					"midpoints" : [ 1298.5, 744.0, 1298.5, 744.0 ],
					"source" : [ "obj-100", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-95", 0 ],
					"midpoints" : [ 1181.5, 744.0, 1298.5, 744.0 ],
					"source" : [ "obj-102", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-112", 0 ],
					"midpoints" : [ 1124.5, 647.0, 1037.5, 647.0 ],
					"source" : [ "obj-104", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1170.5, 615.0, 1124.5, 615.0 ],
					"source" : [ "obj-105", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-107", 0 ],
					"midpoints" : [ 1495.5, 613.0, 1446.5, 613.0 ],
					"source" : [ "obj-106", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-112", 0 ],
					"midpoints" : [ 1446.5, 639.0, 1037.5, 639.0 ],
					"source" : [ "obj-107", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-112", 0 ],
					"midpoints" : [ 1352.5, 639.0, 1037.5, 639.0 ],
					"source" : [ "obj-108", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-112", 0 ],
					"midpoints" : [ 1248.5, 639.0, 1037.5, 639.0 ],
					"source" : [ "obj-110", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-112", 0 ],
					"midpoints" : [ 1054.5, 588.0, 1037.5, 588.0 ],
					"source" : [ "obj-113", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-116", 0 ],
					"midpoints" : [ 1236.5, 433.0, 1345.5, 433.0 ],
					"source" : [ "obj-117", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1082.5, 374.0, 1068.5, 374.0 ],
					"order" : 2,
					"source" : [ "obj-119", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-51", 0 ],
					"midpoints" : [ 1082.5, 356.0, 1120.5, 356.0 ],
					"order" : 1,
					"source" : [ "obj-119", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-35", 0 ],
					"midpoints" : [ 622.5, 435.75, 248.5, 435.75 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 961.5, 412.0, 910.5, 412.0 ],
					"source" : [ "obj-123", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-118", 0 ],
					"midpoints" : [ 938.5, 368.0, 1068.5, 368.0 ],
					"order" : 1,
					"source" : [ "obj-124", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 938.5, 446.5, 443.5, 446.5 ],
					"order" : 3,
					"source" : [ "obj-124", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 780.25, 209.25, 938.5, 209.25 ],
					"order" : 0,
					"source" : [ "obj-128", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 780.25, 215.0, 780.25, 215.0 ],
					"order" : 1,
					"source" : [ "obj-128", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 541.5, 395.75, 681.5, 395.75 ],
					"order" : 0,
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 681.5, 680.0, 1126.0, 680.0, 1126.0, 498.0, 1570.5, 498.0 ],
					"source" : [ "obj-131", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-112", 0 ],
					"midpoints" : [ 616.0, 729.0, 826.75, 729.0, 826.75, 639.0, 1037.5, 639.0 ],
					"source" : [ "obj-134", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 492.5, 528.0, 557.5, 528.0 ],
					"source" : [ "obj-135", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-112", 0 ],
					"midpoints" : [ 827.25, 618.0, 1037.5, 618.0 ],
					"source" : [ "obj-137", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-141", 0 ],
					"midpoints" : [ 1522.5, 269.0, 1321.5, 269.0 ],
					"source" : [ "obj-139", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1082.5, 408.0, 1236.5, 408.0 ],
					"order" : 0,
					"source" : [ "obj-143", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-52", 0 ],
					"midpoints" : [ 1082.5, 433.0, 1105.5, 433.0 ],
					"order" : 1,
					"source" : [ "obj-143", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1082.5, 433.0, 970.5, 433.0 ],
					"order" : 2,
					"source" : [ "obj-143", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 673.0, 486.0, 523.5, 486.0 ],
					"source" : [ "obj-144", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 483.5, 446.0, 483.5, 492.0, 492.5, 492.0 ],
					"source" : [ "obj-145", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 256.5, 627.5, 379.5, 627.5 ],
					"source" : [ "obj-150", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-112", 0 ],
					"midpoints" : [ 443.5, 626.5, 1037.5, 626.5 ],
					"source" : [ "obj-151", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-144", 0 ],
					"midpoints" : [ 443.5, 566.0, 607.0, 566.0, 607.0, 449.0, 673.0, 449.0 ],
					"order" : 0,
					"source" : [ "obj-153", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-95", 0 ],
					"midpoints" : [ 981.5, 803.0, 967.0, 803.0, 967.0, 753.0, 1298.5, 753.0 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-95", 0 ],
					"midpoints" : [ 1025.5, 839.0, 958.0, 839.0, 958.0, 750.0, 1298.5, 750.0 ],
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-35", 0 ],
					"midpoints" : [ 541.5, 435.75, 248.5, 435.75 ],
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-35", 0 ],
					"midpoints" : [ 456.5, 435.75, 248.5, 435.75 ],
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-95", 0 ],
					"midpoints" : [ 956.5, 747.0, 1298.5, 747.0 ],
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-142", 0 ],
					"midpoints" : [ 378.5, 329.5, 621.5, 329.5 ],
					"order" : 1,
					"source" : [ "obj-41", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 378.5, 143.5, 1080.5, 143.5 ],
					"order" : 0,
					"source" : [ "obj-41", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 281.5, 309.25, 827.25, 309.25 ],
					"order" : 0,
					"source" : [ "obj-43", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1105.5, 487.0, 1165.5, 487.0 ],
					"source" : [ "obj-52", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-112", 0 ],
					"midpoints" : [ 970.5, 648.0, 1037.5, 648.0 ],
					"source" : [ "obj-54", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-118", 0 ],
					"midpoints" : [ 1269.5, 380.0, 1068.5, 380.0 ],
					"source" : [ "obj-65", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-117", 0 ],
					"midpoints" : [ 1334.5, 405.0, 1236.5, 405.0 ],
					"source" : [ "obj-66", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-117", 0 ],
					"midpoints" : [ 1422.5, 408.0, 1236.5, 408.0 ],
					"source" : [ "obj-68", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1165.5, 515.0, 1152.0, 515.0, 1152.0, 493.0, 1024.5, 493.0 ],
					"source" : [ "obj-73", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1345.5, 543.0, 1332.0, 543.0, 1332.0, 491.0, 1217.5, 491.0 ],
					"source" : [ "obj-74", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-72", 0 ],
					"midpoints" : [ 1506.5, 493.0, 1345.5, 493.0 ],
					"source" : [ "obj-76", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-72", 0 ],
					"midpoints" : [ 1494.5, 493.0, 1345.5, 493.0 ],
					"source" : [ "obj-77", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-74", 1 ],
					"midpoints" : [ 1570.5, 519.0, 1397.5, 519.0 ],
					"source" : [ "obj-82", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-103", 0 ],
					"hidden" : 1,
					"midpoints" : [ 932.0, 814.0, 910.5, 814.0 ],
					"source" : [ "obj-93", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 1609.5, 677.0, 1181.5, 677.0 ],
					"order" : 4,
					"source" : [ "obj-94", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-111", 0 ],
					"hidden" : 1,
					"midpoints" : [ 1609.5, 589.0, 1248.5, 589.0 ],
					"order" : 3,
					"source" : [ "obj-94", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 1609.5, 422.0, 1536.5, 422.0 ],
					"order" : 1,
					"source" : [ "obj-94", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-82", 0 ],
					"hidden" : 1,
					"midpoints" : [ 1609.5, 473.0, 1570.5, 473.0 ],
					"order" : 0,
					"source" : [ "obj-94", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 1609.5, 681.0, 1298.5, 681.0 ],
					"order" : 2,
					"source" : [ "obj-94", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 0 ],
					"hidden" : 1,
					"midpoints" : [ 1591.5, 770.0, 981.5, 770.0 ],
					"order" : 2,
					"source" : [ "obj-96", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 1591.5, 675.0, 932.0, 675.0 ],
					"order" : 3,
					"source" : [ "obj-96", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 353.5, 663.5, 335.833333333333314, 663.5 ],
					"source" : [ "obj-98", 0 ]
				}
